    ...
    <View style={styles.container}>
      ...
      <Surface style={styles.infoCard}>
        ...
        <Text style={styles.infoText}>
          Transaction of Amt: {transactionAmt}
        </Text>
        <TouchableOpacity
        ...
        >
          {tableList.map((table) => (
            <TouchableOpacity
              ...
              style={[
                styles.tableBtn,
                selectedTable === table.name && styles.selectedTableBtn,
              ]}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            <Text style={styles.modalTitle}>
              Buffet Name : Breakfast Buffet
            </Text>
            <Text style={styles.modalText}>
              Items : Poori, All types of Dosa, Chow Chow Bath, Rice Bath
            </Text>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.profileCard}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                /* Add logout logic here */ setProfileVisible(false);
              }}
            >
