...
export default function UserManagementScreen() {
  ...
  const [form, setForm] = useState({ name: '', password: '', role: '', phone: '' });
      ...
      <FlatList
        ...
        ListFooterComponent={
          <TouchableOpacity style={styles.addBtn} onPress={() => setModalVisible(true)}>
            <MaterialCommunityIcons name="plus-circle-outline" size={54} color="#7b6eea" />
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            />
            <Button mode="contained" style={styles.saveBtn} onPress={handleAddUser}>Save</Button>
          </View>
        </View>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  input: { width: '100%', marginBottom: 12, borderRadius: 8, backgroundColor: '#eae6ff', padding: 10 },
