...
export default function TabBar({ activeTab }) {
  ...
  return (
    <View style={{ position: 'absolute', left: 0, right: 0, bottom: 0, backgroundColor: '#a6a6e7', borderTopLeftRadius: 32, borderTopRightRadius: 32, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', paddingVertical: 12, elevation: 8 }}>
      {tabs.map((tab) => (
        <TouchableOpacity
          key={tab.key}
