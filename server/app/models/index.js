...
db.orders.hasMany(db.orderProducts_, {
  foreignKey: "orderId",
  as: "orderProducts",
});
db.orderProducts_.belongsTo(db.orders, { foreignKey: "orderId", as: "order" });
db.menu.hasMany(db.menuItem, { foreignKey: "menuId", as: "menuItems" });
db.menuItem.belongsTo(db.menu, { foreignKey: "menuId", as: "menu" });
// Associate orderProducts with menuItem
db.orderProducts_.belongsTo(db.menuItem, {
  foreignKey: "menuitemId",
  as: "menuitem",
});
db.menuItem.hasMany(db.orderProducts_, {
  foreignKey: "menuitemId",
  as: "orderProducts",
});
...
db.qrCode.belongsTo(db.restaurantTable, {
  foreignKey: "restTableId",
  as: "restaurantTable",
});
db.restaurantTable.hasMany(db.qrCode, {
  foreignKey: "restTableId",
  as: "qrcodes",
});
db.restaurantUser.belongsTo(db.restaurant, {
  foreignKey: "restaurantId",
  as: "employerRestaurant",
});
...
db.orderProducts_.belongsTo(db.orders, {
  foreignKey: "orderId",
  as: "parentOrder",
});

// Order Products associations with MenuItem
db.orderProducts_.belongsTo(db.menuItem, {
  foreignKey: "menuitemId",
  as: "orderedMenuItem",
});
...
db.restaurantRating.belongsTo(db.restaurant, {
  foreignKey: "restaurantId",
  as: "ratedRestaurant",
});
db.restaurant.hasMany(db.restaurantRating, {
  foreignKey: "restaurantId",
  as: "restaurantRatings",
});
db.restaurantRating.belongsTo(db.users, { foreignKey: "userId", as: "rater" });
